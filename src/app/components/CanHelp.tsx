          ...
          <div key={index} className="">
            <div className=" bg-gray-50 rounded-3xl overflow-hidden p-4 lg:p-14">
              <div className="w-full lg:w-1/2 p-4 mb-6">
                ...
                <p className="text-gray-900 text-6xl font-semibold">
                  {data?.description}
                </p>
              </div>
              <div className="flex flex-col lg:flex-row items-start justify-start ">
                <div className="w-full lg:w-1/2 space-y-4  p-10">
                  ...
                  <Link
                    href={"/"}
                    className="p-3.5 lg:px-8 font-bold text-center hidden lg:flex text-base border bg-gray-900 text-gray-800   w-1/2 rounded-full items-center justify-center"
                  >
                    Review my portfolio
                ...
                <div className="w-full lg:w-1/2">
                  <div className="h-96 bg-gray-800 text-center lg:p-8 lg:px-16 border border-gray-900 rounded-4xl w-full">
                    <Image
                      src="/graph.svg"
                      width={800}
                      height={800}
