...
export default function ColorChangeText({ text }: { text: string }) {
    ...
    const handleScroll = () => {
      if (textRef.current) {
        ...
        const newColors = words.map((_, i) =>
          i / words.length < scrollPercent ? "text-gray-800" : "text-gray-500"
        );
  ...
  return (
    <div className=" flex flex-col items-center justify-center bg-white text-center p-4 lg:p-16">
      <p
      ...
      <div className="w-full lg:w-3/5 flex justify-start items-center gap-4">
        ...
        <div className="text-left">
          <h2 className="text-3xl font-semibold text-gray-800">Sandeep Jethwani</h2>
