...

                {
                    Array(3).fill(null).map((data, index) => (
                        ...
                        <div key={index} className="rounded-3xl h-96 w-full overflow-hidden bg-[#1d1d1d] relative">
                            ...
                            />
                            <div className="flex flex-col items- justify-between bg-[#181818] p-4 absolute shadow-[5px_5px_5px_white]    bottom-0 w-full">
                                <div className='w-full text-center flex justify-between items-center'>
                                    <p className='text-base text-gray-500 '>Co founder</p>
                                ...
                                <div className='py-3 mr-auto'>
                                    <h2 className="text-xl text-gray-100 font-semibold">Vaibhav Parbal</h2>
                                </div>
                            </div>
                        </div>
                    ))
