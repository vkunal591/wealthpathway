  ...
  return (
    <nav className="flex item-center justify-between bg-[#0000008c] z-[5000] text-green-50 w-11/12 m-auto p-4 rounded-xl fixed left-1/2 -translate-x-1/2 top-7">
      <div className="w-1/2 lg:w-1/5 flex items-center justify-start  ">
        <Link href={"/"}>
          <Image
            ...
            className="h-16 lg:h-auton filter invert "
          />
        </Link>
      </div>
      ...
      <div className="w-1/2 lg:w-2/5 flex justify-end lg:justify-center items-center">
        ...
        <Link
          href={"/"}
          className="p-3 lg:px-8 font-bold text-center  hidden lg:flex text-base border bg-gray-50 text-gray-800 rounded-full  item-center justify-center"
        >
          Review my portfolio
