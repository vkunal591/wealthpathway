...
export default function HeroSection() {
    ...
    return (
        <div className='p-4 lg:p-16 max-w-7xl m-auto flex flex-col justify-end items-start h-[70vh] sm:h-[50vh] lg:h-screen'>
            ...
            >
                India&apos;s Premier <br /> Alternative Investments Platform
            </motion.h1>
            <motion.div
            ...
            >
                <Link href={"/"} className='p-3.5 px-6 font-bold text-lg border border-gray-900 bg-gray-50 text-gray-800 rounded-full flex items-center justify-center'>
                    Start your journey
