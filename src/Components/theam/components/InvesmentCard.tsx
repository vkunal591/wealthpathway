      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mb-8">
        {data.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="border border-gray-200 group hover:shadow hover:bg-[#0A2B58] hover:scale-105 transition-all ease-in-out duration-300 bg-white p-4 mb-4 w-full h-auto m-auto flex flex-col items-center justify-center"
            >
