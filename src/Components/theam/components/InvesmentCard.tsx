...
export default function InvesmentCard() {
  ...
  return (
    <div className="max-w-7xl m-auto p-4 lg:p-16 lg:pb-4 text-blue-900">
      <div className="grid grid-cols-1 md:grid-cols-4 shadow mb-8">
        {data.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="border border-gray-200 group hover:shadow hover:scale-105 transition-all ease-in-out duration-300 bg-white p-4 w-full h-auto m-auto flex flex-col items-start justify-start"
            >
